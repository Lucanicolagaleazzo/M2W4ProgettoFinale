...
function cercaLavori(userLocation,title){
  ...
  function mostraRisultati(){
    let location = document.getElementById("località").value
    let title = document.getElementById("lavoro").value 
    let lavoriCercati = cercaLavori(location,title)
    let contenitore = document.getElementById("results")
  
  const ul = document.getElementById("results")
    ul.innerHTML = ""
  
  if(location === "" || title === ""){
    alert("Prima inserisci i parametri per effettuare la ricerca")
  }else{
